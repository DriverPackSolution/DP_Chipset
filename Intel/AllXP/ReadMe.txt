...
* Intel(R) TPM Windows* XP Driver V4.0.1
*	
****************************************
...
The Intel(R) TPM Windows* XP Driver is 
the interface between the Intel(R) TPM
firmware and the host OS. Applications
on the host that wish to interact with
Intel(R) TPM use the TDDL.dll
that is part of the Intel(R) TPM
Windows* XP driver package. This file is
the Intel implementation of the
TCG device driver library and is found
...
* Please note that Windows* Vista and Windows* 7 contain by default a driver that supports Intel(R) TPM. 
